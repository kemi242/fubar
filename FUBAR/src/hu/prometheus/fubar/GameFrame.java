...
public class GameFrame extends JFrame {
	...
	private void init() {
		...
		lblMenu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				do_lblMenu_mousePressed(e);
			}
			@Override
			public void mouseReleased(MouseEvent e) {
				do_lblMenu_mouseReleased(e);
			}
		});
		lblMenu.setIcon(new ImageIcon(GameFrame.class.getResource("/hu/prometheus/fubar/res/Menu gomb.png")));
	...
	protected void do_lblMenu_mousePressed(MouseEvent e) {
		lblMenu.setIcon(new ImageIcon(DrawFrame.class.getResource("/hu/prometheus/fubar/res/Menu gomb L.png")));
	}
	protected void do_lblMenu_mouseReleased(MouseEvent e) {
		lblMenu.setIcon(new ImageIcon(DrawFrame.class.getResource("/hu/prometheus/fubar/res/Menu gomb.png")));
	}
}
